...
def train(rank, world_size, trainloader, testloader, net, num_epochs, criterion, optimizer, save_path):
    ...
    return losses, train_accuracies, test_accuracies, total_time
...
def main():
    ...
    configs = [
        ...
        {"num_epochs": 50, "lr": 0.01, "momentum": 0.9, "batch_size": 32},
        {"num_epochs": 50, "lr": 0.01, "momentum": 0.9, "batch_size": 64},
        {"num_epochs": 50, "lr": 0.01, "momentum": 0.9, "batch_size": 512},
    ]
    ...
    for i, config in enumerate(configs):
        ...
        save_path = f'./modelset/Original_version_model_multiGPU/config_{i+1}'
        if rank == 0:
            os.makedirs(save_path, exist_ok=True)

        train_losses, train_accuracies, test_accuracies, training_time = train(
    ...
    if rank == 0:
        with open('./modelset/Original_version_model_multiGPU/training_results.json', 'w') as f:
